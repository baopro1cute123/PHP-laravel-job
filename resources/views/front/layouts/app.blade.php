...
<head>
	...
	<meta name="description" content="Find the best job opportunities with CareerVibe." />
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<a class="btn btn-outline-primary me-2" href="{{ route('account.login') }}" type="submit">Login</a>
					...
					@endif
					<a class="btn btn-outline-primary me-2" href="{{ route('account.profile') }}" type="submit">Hello! {{ Auth::user()->name }}</a>
